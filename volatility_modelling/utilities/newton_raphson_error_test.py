...
def nr_mae_errors():
    ...
    for expiry in expiry_dates:
        ...
        nr = NewthonRaphson(max_iter=1000)
        ...
        for idx, row in data.iterrows():
            ...
            implied_vol = nr.nr_solution(spot_price=spot_price, strike_price=k, r=risk_free_rate, initial_guess=1.0, t=maturities, market_price=C)
        ...
        for error in residuals:
            ...
            if np.isnan(error) or error > 0.05 or error < -0.05:
                fails += 1
